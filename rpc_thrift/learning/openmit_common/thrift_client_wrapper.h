...
template<class Client>
void ThriftClientWrapper<Client>::InitThriftClient(const std::vector<std::string>& hosts, 
                                                   const std::vector<int>& ports) {
...
template<class Client>
void ThriftClientWrapper<Client>::InitThriftClient(const std::string& host, const int port) {
